...
### 11. No OTP / email verification — signup is instant and unverified
...
### 12. SMS phone numbers aren't format-validated, and sends fail silently
...
### 13. `supabase-schema.sql` doesn't reliably reflect the live database — verify before trusting it
...
### 14. Trekker wishlist ("save a trek") has no UI at all
...
### 15. Trekker `review_count` never increments
