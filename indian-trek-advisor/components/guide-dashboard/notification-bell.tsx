...
export function NotificationBell() {
  ...
  async function markRead(id: string) {
    ...
    try {
      await fetch(`/api/guide/notifications/${id}/read`, { method: "POST" })
    } catch {
      // local state already optimistically updated; a failed sync just means
      // it may show as unread again next fetch, which is an acceptable fallback
    }
  }
  ...
  async function markAllRead() {
    ...
    try {
      await fetch("/api/guide/notifications/read-all", { method: "POST" })
    } catch {
